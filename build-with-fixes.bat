...
echo ExecStart=/usr/local/bin/serve -s /opt/tax-advisor/taxprofessional-frontend -l 5173>> deploy\tax-advisor\scripts\tax-advisor-taxprofessional-frontend.service
